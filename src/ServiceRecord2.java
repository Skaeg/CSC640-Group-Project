 ...
 */
public class ServiceRecord2 implements Serializable{
    ...
    public ServiceRecord2(){}

    public ServiceRecord2(int providerID, int memberID, int serviceCode, String comments,
